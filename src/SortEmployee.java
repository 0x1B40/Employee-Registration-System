...
public class SortEmployee extends JFrame {
    ...
    public void sortByEmpID() {
        ...
        int maxSize = EmployeeListMenu.employeeList.maxSize;
        EmployeeList newEmployeeList = new EmployeeList ( maxSize );
        int listSize = EmployeeListMenu.employeeList.getSize ();


        for (int i = 0; i < listSize; i++) {
            for (int j = i; j < listSize; j++) {
                if (EmployeeListMenu.employeeList.list[i].getEmpID () > EmployeeListMenu.employeeList.list[j].getEmpID ()) {
                    Employee temp = EmployeeListMenu.employeeList.list[i];
                    EmployeeListMenu.employeeList.list[i] = EmployeeListMenu.employeeList.list[j];
                    EmployeeListMenu.employeeList.list[j] = temp;
                }
        ...
        for(int i = 0;i<listSize;i++)
        {
          System.out.println(  EmployeeListMenu.employeeList.list[i].getEmpID ());
        }
    ...
    private class ButtonHandler implements ActionListener
    {
        public void actionPerformed(ActionEvent event)
        {
            ...
            {
                SortEmployee.this.setVisible(false);
