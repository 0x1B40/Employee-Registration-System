...
public class UpdateRecordsMenu extends JFrame {
    ...
    public UpdateRecordsMenu()
    {
        ...
        editEmployeeButton.addActionListener(buttonHandler);
...
private class ButtonHandler implements ActionListener
{
    ...
    {
        if(event.getSource() == editEmployeeButton)
        {
            if(isMale)
                gender='M';
            else
            ...
            try {
                ...
                EmployeeListMenu.employeeList.updateRecord ( emp, empID );
                UpdateRecordsMenu.this.setVisible ( false );
            }
            catch(InvalidIDException exp)
            {
                JOptionPane.showMessageDialog ( null,"Invalid ID! caught in add employee menu" );
